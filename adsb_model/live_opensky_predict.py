...
OUTPUT_DIR = Path("live_opensky_outputs")
OUTPUT_DIR.mkdir(exist_ok=True)

HISTORY_CSV = OUTPUT_DIR / "opensky_history.csv"
LATEST_PREDICTIONS_CSV = OUTPUT_DIR / "opensky_latest_predictions.csv"
LIVE_MAP_HTML = OUTPUT_DIR / "opensky_live_map.html"
